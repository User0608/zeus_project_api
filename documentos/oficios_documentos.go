...
func NewOficio(m models.Oficio) *Oficio {
	...
	return &Oficio{
		...
		Oficio: models.Oficio{
			Codigo:     fmt.Sprintf("OFICIO Nº %s/UBO \"Nstra. Sra. de Gpe.\"-G/C", m.Codigo),
...
func (m *Oficio) PDF(savePath string) error {
